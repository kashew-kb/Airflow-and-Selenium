...
from selenium_scripts.scrape_trade_yearly_import import get_df as get_df
...
def load_data(countryname, hslevel, currency, countrycode, **context):
    ...
    Doc_Source={
            ...
            "Description": "India imported this commodity from " + countryname,
            "Frequency": "Yearly",
            "Mode":"Import",
            "HSCodeLevel": hslevel,
            "Value": currency,
